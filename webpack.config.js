  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        ...
        description:
          "100% локализация производства пищевых пластичнатых теплообменников для различных сфер пищевой промышленности под самые сложные технологические процессы.",
      },
    ...
    new HtmlWebpackPlugin({
      ...
      heading:
        "Два теплообменника по 3,5 Гкал/ч для горячего водоснабжения, г.Тимашевск",
      meta: {
    ...
    new HtmlWebpackPlugin({
      ...
      heading:
        "Теплообменник пластинчатый в котельной жилого района Затон-Восточный, г. Уфа",
      meta: {
    ...
    new HtmlWebpackPlugin({
      ...
      title:
        "Проектирование блочных тепловых пунктов | Особенности изготовления",
    ...
    new HtmlWebpackPlugin({
      templateParameters: {
        ...
        relevanceArticles: [
          {
            name: "Пластинчатый охдадитель ООЛ-10",
            link: "/blog-proizvodstva/plastinchatii-ohladitel-ool-10.html",
          },
        ],
      },
      title:
        "Пластинчатые охладители молока | Охлаждение молока в потоке | ООЛ-3 | ООЛ-5",
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        ...
        description:
          "Как внедряются в производство новые пластинчатые теплообменники. Разработка и изготовление пластин и уплотнений, подготовка конструкторской документации. Первый пластинчатый теплообменник ДУ250 российского производства.",
      },
      template: "./src/blog-page-abstract.html",
