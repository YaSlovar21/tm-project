...
module.exports = {
  ...
  new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      ...
      intro: "Как осуществляется монтаж теплообменного аппарата? Особенности монтажа пластинчатых теплообменников. Важные моменты на что нужно обратить внимание при монтаже, запуске теплообменника.",
      meta: {
