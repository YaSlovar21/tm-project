...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        keywords:
          "пластинчатые теплообменники, пластинчатый теплообменник",
        description:
    ...
    new HtmlWebpackPlugin({
      ...
      heading: "Два теплообменника по 3,5 Гкал/ч для горячего водоснабжения, г.Тимашевск",
      meta: {
    ...
    new HtmlWebpackPlugin({
      ...
      heading: "Теплообменник пластинчатый в котельной жилого района Затон-Восточный, г. Уфа",
      meta: {
    ...
    new HtmlWebpackPlugin({
      ...
      title: "Теплообменники отопления, гвс, теплого пола в ИТП для умного дома в г. Уфа",
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        keywords: "многосекционные теплообменники, многосекционные пластинчатые теплообменники",
        description:
    ...
    new HtmlWebpackPlugin({
      ...
      title: "Пластинчатые охладители молока ООЛ-3 | ООЛ-5",
