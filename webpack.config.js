...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        keywords: "пластинчатые теплообменники, производство пластинчатых теплоомбенников",
        description: "100% локализация производства пластинчатых теплообменников: пластин, уплотнений, теплообменников. Выгодное предложение за счёт оптовой закупки металла и серийного производства пластин.",
      },
    ...
    new HtmlWebpackPlugin({
      ...
      title:
        "Пищевые теплообменники | Пластинчатые пастеризаторы и охладители | ООЛ | для молока, сусла и пищевых жидкостей",
      meta: {
        keywords: "пищевые теплообменники, пластинчатые пищевые теплообменники",
        description: "100% локализация производства пищевых пластичнатых теплообменников для различных сфер пищевой промышленности под самые сложные технологические процессы.",
      },
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        keywords: "пластина пластинчатого теплообменника, уплотнение пластинчатого теплообменника",
        description: "Серийное производство со 100% локализацией на предприятии пластин и уплотнений. Комплектующие всегда в наличии, осуществляем сервисное обслуживание пластинчатых теплобоменников Теплохит.",
      },
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        ...
        description: "Информация о предприятии-производителе пластинчатых теплообменников полного цикла. Разработка и производство пластин и уплотнений, изготовление пластинчатых теплобменников.",
      },
    ...
    new HtmlWebpackPlugin({
      ...
      title: "Пластинчатые теплообменники отопления | Принцип работы | Как подобрать теплообменник для отопления",
    ...
    new HtmlWebpackPlugin({
      ...
      title: "Пластинчатые теплообменники горячего водоснабжения ГВС | Принцип работы разборного теплообменника | Моноблоки ГВС",
      heading: "Пластинчатые теплообменники горячего водоснабжения",
      meta: {
        keywords: "теплообменники гвс, пластинчатые теплообменники гвс",
        description: "Как подобрать пластинчатый теплообменник для гвс, особенности производства и применения. Онлайн форма для подбора теплообменника системы горячего водоснабжения.",
      },
      template: "./src/blog-page-abstract.html",
    ...
    new HtmlWebpackPlugin({
      ...
      title: "Пластинчатые пастеризаторы для молока, сливок, пива | Преимущества над трубчатыми",
      heading: "Пластинчатые пастеризаторы",
      meta: {
        keywords: "пастеризатор, пластинчатый пастеризатор",
        description: "Производство пластинчатых пастеризаторов, особенности использования. Как подобрать пластинчатый пастеризатор для молочной промышленности и других пищевых производств.",
      },
      template: "./src/blog-page-abstract.html",
    ...
    new HtmlWebpackPlugin({
      ...
      templateParameters: {
        ...
        heading: "ТИ 18",
        headingAlias: "ТИ18",
        description: `ТИ18 – имеет широкую гамму подключения подтрубков: Ду50, Ду65.
          ...
          Теплообменный аппарат похож на ТИ13, но в отличие от него лучше справляется с более жесткиеи температурными режимами`,
